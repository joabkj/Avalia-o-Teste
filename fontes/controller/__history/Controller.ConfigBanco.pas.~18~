...
type
  ...
  public
    ...
    class function ReconstroiConexao: Boolean;
    constructor Destroy;
...
class function TServerConfig.ReconstroiConexao: Boolean;
begin
  FInstance.FDManager.Free;
  FreeAndNil(FInstance);
  GetInstance(FSenha, FBanco, 'PG');
end;

constructor TServerConfig.Destroy;
begin
